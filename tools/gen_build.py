...
helper = (
    ...
    "  // Default effort:'medium' so engineer agents don't enter 90-min reasoning loops\n"
    "  // between tool calls. Callers that pass effort explicitly (architect/security) keep theirs.\n"
    "  const opts = { effort: 'medium', ...(o || {}) }\n"
